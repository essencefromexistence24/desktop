...
import type {
  GeneratedInstrumentalBusyState,
  GeneratedInstrumentalJobView,
} from "@/features/ai/use-generated-instrumental-job";

type GeneratedInstrumentalPanelProps = {
  busy: GeneratedInstrumentalBusyState;
  job?: GeneratedInstrumentalJobView;
  onRefresh: () => Promise<unknown>;
  onSave: () => Promise<unknown>;
};

export function GeneratedInstrumentalPanel({
  busy,
  job,
  onRefresh,
  onSave,
}: GeneratedInstrumentalPanelProps) {
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button
              ...
              title={actionGuard.title("Save instrumental")}
              onClick={() => {
                void onSave();
              }}
            >
      ...
      <CardContent className="space-y-3">
        ...
        {job.audio?.available && job.audio.audioUrl ? (
          ...
          <p className="text-sm text-muted-foreground">
            Waiting for the configured music provider to return a real instrumental.
          </p>
        )}
      </CardContent>
    </Card>

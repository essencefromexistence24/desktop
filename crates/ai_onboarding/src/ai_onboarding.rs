...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            ...
            .child(
                Label::new("Subscriptions & Pro features are provided entirely by Zed. This editor is a Zed fork; we surface the same Zed subscriptions — all thanks go to Zed.")
                    .color(Color::Muted)

...
const MAX_MEDIA_RESULTS: usize = 100000; // support millions from DX media dirs; UI virtualizes/list caps display
const MAX_REMOTE_MEDIA_RESULTS: usize = 10000; // fetch way more (millions available)

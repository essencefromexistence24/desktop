...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Dx Route Documentation",
    description: "Comprehensive docs for Dx Route AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get Dx Route running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let Dx Route pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">Dx Route Documentation</h1>

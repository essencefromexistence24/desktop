...
import {
  createAccessibilityLocalizationFinishCenter,
  type AccessibilityLocalizationFinishCenter,
...
export async function listAccessibilityLocalizationFinishCenter(
  userId: string,
): Promise<AccessibilityLocalizationFinishCenter> {
  ...
  return createAccessibilityLocalizationFinishCenter({

import { computeTarget } from "../../../../../../route/open-sse/services/compression/adaptiveCompression/computeTarget.ts";
import type { ContextBudgetConfig } from "../../../../../../route/open-sse/services/compression/adaptiveCompression/types.ts";

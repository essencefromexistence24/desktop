...
import { findUserBySessionHash, sessionRequiresMfa } from './sessions'
import { jsonResponse } from '../http'
import { findFirstOwner, type AuthUser } from '../repositories/users'
...
export async function requireAuthenticatedUser(
  ...
  if (!user) {
    ...
    const defaultUser = await findFirstOwner(db)

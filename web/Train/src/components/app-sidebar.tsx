...
// `localStorage.setItem("train_force_update_card", "1")` and reload. Remove
// before merge.
function devForceUpdateCard(): boolean {
  if (typeof window === "undefined") return false;
  try {
    return window.localStorage.getItem("train_force_update_card") === "1";
  } catch {
    return false;
  }
}
...
export function AppSidebar() {
  ...
  // after a reinstall/update dropped MLX and is recoverable via `train studio update`.
  const trainExportDisabledHint: string | undefined = !chatOnly
    ? undefined
    : chatOnlyReason === "mlx_unavailable"
      ? "Training needs MLX. Run `train studio update` to enable Train and Export."
      ...
      <SidebarMenuItem key={item.id} className={itemClass}>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            ...
            align="start"
            sideOffset={0}
            className="train-plus-menu menu-flat-destructive w-56"
          >
            ...
            <DropdownMenuSub>
              ...
              <DropdownMenuSubContent
                sideOffset={0}
                alignOffset={-4}
                className="train-plus-menu w-52"
              >
                <DropdownMenuItem
                  onSelect={() => {
            ...
            <DropdownMenuSub>
              ...
              <DropdownMenuSubContent sideOffset={8} alignOffset={-4} className="train-plus-menu w-52">
                {[

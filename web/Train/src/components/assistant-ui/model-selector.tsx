  ...
  return (
    <PopoverTrigger asChild={true}>
      <button
        ...
        data-tour={dataTour}
        className={cn(
          "train-model-selector-trigger flex min-w-0 items-center gap-2 transition-colors",
          variant === "outline" &&
...
const HUB_SECTION_KEY = "train_model_selector_section";
...
function ModelSelectorContent({
  ...
  return (
    <PopoverContent
      ...
      className={cn(
        "train-model-selector-menu menu-soft-surface ring-0 max-w-[calc(100vw-1rem)] min-w-0 gap-0 pt-4 pb-0 pl-4",

      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-start pt-[27.5vh]">
        <div className="aui-thread-welcome-message flex w-full flex-col justify-center gap-9 px-4">
          ...
          <div className="flex flex-row items-center justify-center gap-[15px]">
            ...
            />
            <h1 className="aui-thread-welcome-message-inner train-welcome-title fade-in slide-in-from-bottom-1 animate-in text-3xl tracking-[-0.02em] duration-200">
...
const Composer: FC<{
  ...
  const composerContent = (
    <>
      ...
      <ToolStatusDisplay />
      <div
        className="train-composer-line"
        data-expanded={composerExpanded ? "true" : "false"}
      >
        <div
          className="train-composer-left"
        ...
        <ComposerPrimitive.Input
          ...
          ref={inputRef}
          className="aui-composer-input train-composer-input"
          minRows={1}
          maxRows={12}
          autoFocus={!disabled}
          disabled={disabled}
  ...
  return (
    ...
    >
      ...
      {isTauri ? (
        ...
        <div className="aui-composer-attachment-dropzone train-composer-surface relative z-10">
          {composerContent}
        </div>
      ) : (
        <ComposerPrimitive.AttachmentDropzone className="group/dropzone aui-composer-attachment-dropzone train-composer-surface relative z-10">
          {composerContent}
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent
          ...
          className="train-plus-menu train-thinking-menu min-w-0 w-[176px]"
        >
          {isEffort ? (
            <>
  ...
  const plusMenuNodes: Record<PlusMenuItemId, ReactNode> = {
    ...
    savedPrompts: (
      <DropdownMenuSub>
        ...
        <DropdownMenuSubContent
          collisionPadding={16}
          className="train-plus-menu w-[208px]"
        >
          {recentPrompts.map((p) => (
            <DropdownMenuItem
              key={p.id}
    ...
    projects: (
      <DropdownMenuSub>
        ...
        <DropdownMenuSubContent className="train-plus-menu w-[232px]">
  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent
        ...
        sideOffset={0}
        avoidCollisions={true}
        className="train-plus-menu w-[244px]"
      ...
      >
        ...
        {overflowPlusItems.length > 0 ? (
          <DropdownMenuSub>
            ...
            <DropdownMenuSubContent className="train-plus-menu w-[248px]">

...
export const en = {
  ...
  settings: {
    ...
    dialog: {
      title: "Settings",
      description: "Manage your Train preferences.",
    ...
    general: {
      title: "General",
      description: "Global preferences for Train.",
      account: "Account",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Clears local-only preferences and reloads Train. Chats, API access, and DB-backed settings are kept.",
        confirmAction: "Reset and reload",
      },
    },
    profile: {
      title: "Profile",
      description: "How your profile appears in Train.",
      changePicture: "Change profile picture",
      displayName: "Display name",
      nickname: "What should Train call you?",
    ...
    appearance: {
      title: "Appearance",
      description: "How Train looks on this device.",
      theme: {
        title: "Theme",
        label: "Color scheme",
      ...
      language: {
        ...
        description: "The language used by Train.",
      },
      layout: {
        title: "Layout",
    ...
    apiKeys: {
      title: "API",
      description: "Access Train via the OpenAI-compatible API.",
      ...
      secureHttpsHint:
        "The 0.0.0.0 port is still reachable globally. For full security, launch Train Studio with --secure to expose only this HTTPS link.",
    ...
    about: {
      ...
      license: {
        ...
        libraryLabel: "Train Core",
        libraryLicense: "Apache-2.0",
        libraryDescription: "Licensed under Apache 2.0.",
      },
      dangerZone: "Danger zone",
      shutDownStudio: "Shut down Train",
      shutDownStudioDescription:
        "Stops the Train server and ends your session.",
      shutDown: "Shut down",
      update: {
        title: "Update Train",
        ...
        checkingInstall: "Checking how Train was installed...",
        installIntro: "To install or update Train:",
        ...
        restartAfterUpdate: "Restart Train after updating.",
        desktopManaged:
          "The desktop app keeps its bundled backend updated and will prompt when a new version is available.",
        unknownInstall:
          "Could not detect how Train was installed. For installer or PyPI installs, use the commands above.",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> train training starts...",

...
const EXTERNAL_PROVIDERS_KEY = "train_chat_external_providers";
const EXTERNAL_PROVIDER_KEYS_KEY = "train_chat_external_provider_keys";
const CONNECTIONS_ENABLED_KEY = "train_chat_connections_enabled";

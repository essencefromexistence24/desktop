...
const HF_TOKEN_KEY = "train_hf_token";
const HF_TOKEN_CHANGED_EVENT = "train:hf-token-changed";
export const CHAT_REASONING_ENABLED_KEY = "train_chat_reasoning_enabled";
export const CHAT_TOOLS_ENABLED_KEY = "train_chat_tools_enabled";
export const CHAT_CODE_TOOLS_ENABLED_KEY = "train_chat_code_tools_enabled";
export const CHAT_IMAGE_TOOLS_ENABLED_KEY = "train_chat_image_tools_enabled";
export const CHAT_ARTIFACTS_ENABLED_KEY = "train_chat_artifacts_enabled";
export const CHAT_COLLAPSE_HTML_ARTIFACTS_KEY =
  "train_chat_collapse_html_artifacts";
export const CHAT_ALLOW_ARTIFACT_NETWORK_ACCESS_KEY =
  "train_chat_allow_artifact_network_access";
export const CHAT_MCP_ENABLED_KEY = "train_chat_mcp_enabled";
export const CHAT_CONFIRM_TOOL_CALLS_KEY = "train_chat_confirm_tool_calls";
export const CHAT_LOAD_ON_SELECTION_KEY = "train_chat_load_on_selection";
export const CHAT_EXPAND_QUANTIZATIONS_KEY =
  "train_chat_expand_quantizations";
export const CHAT_SHOW_ALL_QUANTIZATIONS_KEY =
  "train_chat_show_all_quantizations";
export const CHAT_BYPASS_PERMISSIONS_KEY = "train_chat_bypass_permissions";
export const CHAT_WEB_FETCH_TOOLS_ENABLED_KEY =
  "train_chat_web_fetch_tools_enabled";
export const CHAT_RAG_SOURCE_KEY = "train_chat_rag_source";
export const CHAT_RAG_MODE_KEY = "train_chat_rag_mode";
export const CHAT_RAG_TOP_K_KEY = "train_chat_rag_top_k";
export const CHAT_RAG_AUTOINJECT_KEY = "train_chat_rag_autoinject";
export const CHAT_RAG_AUTOINJECT_MIN_SCORE_KEY =
  "train_chat_rag_autoinject_min_score";
export const CHAT_SPECULATIVE_TYPE_KEY = "train_chat_speculative_type";
...
const LAST_EXTERNAL_CHECKPOINT_KEY = "train_chat_last_external_checkpoint";

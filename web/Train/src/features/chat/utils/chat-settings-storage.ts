...
const AUTO_TITLE_KEY = "train_chat_auto_title";
const AUTO_HEAL_TOOL_CALLS_KEY = "train_auto_heal_tool_calls";
const MAX_TOOL_CALLS_KEY = "train_max_tool_calls_per_message";
const TOOL_CALL_TIMEOUT_KEY = "train_tool_call_timeout";
const INFERENCE_PARAMS_KEY = "train_chat_inference_params";
const CHAT_ACTIVE_PRESET_KEY = "train_chat_active_preset";
const CHAT_ACTIVE_PRESET_SOURCE_KEY = "train_chat_active_preset_source";
const REASONING_EFFORT_KEY = "train_reasoning_effort";
const PRESERVE_THINKING_KEY = "train_preserve_thinking";
const COLLAPSE_HTML_ARTIFACTS_KEY = "train_chat_collapse_html_artifacts";
const ALLOW_ARTIFACT_NETWORK_ACCESS_KEY =
  "train_chat_allow_artifact_network_access";
const CHAT_PRESETS_KEY = "train_chat_custom_presets";
const LEGACY_CHAT_SYSTEM_PROMPTS_KEY = "train_chat_system_prompts";
const LEGACY_CHAT_SETTINGS_IMPORT_KEY =
  "train_chat_settings_imported_to_studio_db";

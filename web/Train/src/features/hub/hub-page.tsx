...
const MODELS_TAB_STORAGE_KEY = "train.hub.modelsTab";
const ALL_MODELS_VIEW_STORAGE_KEY = "train.hub.allModelsView";
const INVENTORY_SORT_STORAGE_KEY = "train.hub.inventorySort";
const OWNER_SCOPE_STORAGE_KEY = "train.hub.ownerScope";
...
const DEFAULT_DISCOVER_CHANNEL: ChannelId = "train-trending";
const FEED_LIST_CHANNEL_ID: ChannelId = "train-latest";

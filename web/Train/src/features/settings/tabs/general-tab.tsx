...
const PREFS_KEYS: string[] = [
  ...
  // UI state
  "sidebar_pinned",
  "train_sidebar_navigate_open",
  "train_settings_active_tab",
  // Chat runtime prefs
  "train_chat_auto_title",
  "train_hf_token",
  "train_auto_heal_tool_calls",
  "train_max_tool_calls_per_message",
  "train_tool_call_timeout",
  "train_chat_inference_params",
  "train_chat_collapsible_state",
  "train_chat_preferences",
  "train_load_settings",
  // Model selector settings ("Select model settings" group)
  "train_chat_load_on_selection",
  "train_chat_expand_quantizations",
  "train_chat_show_all_quantizations",
  // Chat presets
  "train_chat_custom_presets",
  "train_chat_active_preset",
  "train_chat_system_prompts",
  "train_chat_system_prompts_migrated",
  // Training UI prefs
  "train_training_config_v1",
  "train_prev_max_steps",
  "train_prev_save_steps",
  // Profile personalization
  "train_user_profile",
  // Guided tour flags
  "tour:studio:v1",
  // Update notifications
  "train_show_llama_update_banner",
];

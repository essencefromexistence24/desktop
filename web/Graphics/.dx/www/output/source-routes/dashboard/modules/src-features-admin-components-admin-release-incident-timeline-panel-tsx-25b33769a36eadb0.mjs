...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-release-incident-timeline-export-ts-806ed7cd6d953764.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-release-incident-timeline-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-release-incident-timeline-panel-tsx-25b33769a36eadb0.mjs",
  "kind": "tsx",
  "hash": "25b33769a36eadb0",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-release-incident-timeline-export",
      "resolved_path": "src/features/admin/admin-release-incident-timeline-export.ts",

...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-automation-runbook-center-export-ts-23b98a75feec787f.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-automation-runbook-center-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-automation-runbook-center-panel-tsx-dd8b54c5ddeb2ad9.mjs",
  "kind": "tsx",
  "hash": "dd8b54c5ddeb2ad9",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-automation-runbook-center-export",
      "resolved_path": "src/features/admin/admin-automation-runbook-center-export.ts",

...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-publish-channel-manager-export-ts-c61ab8b462f97174.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-publish-channel-manager-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-publish-channel-manager-panel-tsx-8f00906423152699.mjs",
  "kind": "tsx",
  "hash": "8f00906423152699",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-publish-channel-manager-export",
      "resolved_path": "src/features/admin/admin-publish-channel-manager-export.ts",

...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-workspace-operations-export-ts-342ad40333c2d165.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-workspace-operations-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-workspace-operations-panel-tsx-f87f31edb83c0d88.mjs",
  "kind": "tsx",
  "hash": "f87f31edb83c0d88",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-workspace-operations-export",
      "resolved_path": "src/features/admin/admin-workspace-operations-export.ts",

...
export const dxSourceText = "export const publicRouteKinds = [\"share\", \"prototype\", \"embed\"] as const;\n\nexport type PublicRouteKind = (typeof publicRouteKinds)[number];\n";
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/public-route-analytics/types.ts",

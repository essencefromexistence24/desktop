...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-comment-reaction-workflows-ts-226285fbc5d420fc.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-comment-reaction-workflows-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-comment-reaction-workflows-panel-tsx-f9aa235256781464.mjs",
  "kind": "tsx",
  "hash": "f9aa235256781464",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-comment-reaction-workflows",
      "resolved_path": "src/features/admin/admin-comment-reaction-workflows.ts",

...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-realtime-health-monitor-export-ts-b7005984ad75283d.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-realtime-health-monitor-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-realtime-health-monitor-panel-tsx-94e19160386a0621.mjs",
  "kind": "tsx",
  "hash": "94e19160386a0621",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-realtime-health-monitor-export",
      "resolved_path": "src/features/admin/admin-realtime-health-monitor-export.ts",

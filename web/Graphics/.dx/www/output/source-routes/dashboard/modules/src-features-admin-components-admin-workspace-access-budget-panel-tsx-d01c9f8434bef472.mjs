...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-workspace-access-budget-export-ts-2bd877141458edae.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-workspace-access-budget-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-workspace-access-budget-panel-tsx-d01c9f8434bef472.mjs",
  "kind": "tsx",
  "hash": "d01c9f8434bef472",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-workspace-access-budget-export",
      "resolved_path": "src/features/admin/admin-workspace-access-budget-export.ts",

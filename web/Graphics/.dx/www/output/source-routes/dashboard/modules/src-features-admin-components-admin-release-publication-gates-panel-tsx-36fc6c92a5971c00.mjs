...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-release-publication-gates-export-ts-62a0f132368ab297.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-release-publication-gates-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-release-publication-gates-panel-tsx-36fc6c92a5971c00.mjs",
  "kind": "tsx",
  "hash": "36fc6c92a5971c00",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-release-publication-gates-export",
      "resolved_path": "src/features/admin/admin-release-publication-gates-export.ts",

...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-self-hosted-sync-diagnostics-export-ts-508ceb20670be401.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-self-hosted-sync-diagnostics-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-self-hosted-sync-diagnostics-panel-tsx-08c97bc8529e7d18.mjs",
  "kind": "tsx",
  "hash": "08c97bc8529e7d18",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-self-hosted-sync-diagnostics-export",
      "resolved_path": "src/features/admin/admin-self-hosted-sync-diagnostics-export.ts",

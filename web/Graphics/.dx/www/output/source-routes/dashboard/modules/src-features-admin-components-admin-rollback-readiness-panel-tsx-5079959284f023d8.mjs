...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-rollback-readiness-export-ts-a85f94d34130a53d.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-rollback-readiness-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-rollback-readiness-panel-tsx-5079959284f023d8.mjs",
  "kind": "tsx",
  "hash": "5079959284f023d8",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-rollback-readiness-export",
      "resolved_path": "src/features/admin/admin-rollback-readiness-export.ts",
      "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-admin-rollback-readiness-export-ts-a85f94d34130a53d.mjs",
      "kind": "ts",
      "resolver_source": "tsconfig-path",
      "node_modules_required": false
    },

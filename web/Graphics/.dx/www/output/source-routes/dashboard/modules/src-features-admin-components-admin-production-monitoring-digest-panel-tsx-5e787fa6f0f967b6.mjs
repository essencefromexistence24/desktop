...
import { dxSourceModule as dep3, dxRuntimeExports as dep3Runtime } from "./src-features-admin-admin-production-monitoring-digest-export-ts-164b32cce149f6b9.mjs";
...
export const dxSourceModule = Object.freeze({
  "source_path": "src/features/admin/components/admin-production-monitoring-digest-panel.tsx",
  "chunk_output": ".dx/www/output/source-routes/dashboard/modules/src-features-admin-components-admin-production-monitoring-digest-panel-tsx-5e787fa6f0f967b6.mjs",
  "kind": "tsx",
  "hash": "5e787fa6f0f967b6",
  "dependencies": [
    {
    ...
    {
      "specifier": "@/features/admin/admin-production-monitoring-digest-export",
      "resolved_path": "src/features/admin/admin-production-monitoring-digest-export.ts",
